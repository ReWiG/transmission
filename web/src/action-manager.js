...
export class ActionManager extends EventTarget {
  constructor() {
    ...
    this.actions = Object.seal({
      ...
      'download-selected-torrents-random': { enabled: false, text: 'Download selected torrents normally' },
      'download-selected-torrents-sequential': { enabled: false, text: 'Download selected torrents sequentially' },
  ...
  _updateStates(counts) {
    ...
    set_enabled(counts.selected > 0, [
      'deselect-all',
	  'download-selected-torrents-random',
	  'download-selected-torrents-sequential',
      'move-bottom',
      'move-down',
      'move-top',
      'move-up',
